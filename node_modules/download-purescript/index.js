...
const DEFAULT_VERSION = '0.11.7';

const VERSION_ERROR = `Expected \`version\` option to be a string of PureScript version, for exmaple '${DEFAULT_VERSION}'`;
const PLATFORM_ERROR = 'Expected `platform` option to be one of the Node.js platform identifiers, ' +
                       'for exmaple `linux` and `darwin`';
...
module.exports = function downloadPurescript(dir, options) {
  ...
  if (platform !== undefined) {
    ...
    if (!supportedPlatforms.has(platform)) {
      if (!unsupportedPlatforms.has(platform)) {
        ...
        }. The following platform identifiers are available in Node.js: ` +
